...
let guestList: string[] = ["Steve Jobs ", "Mother Teresa ", "Abdul Sattar Edhi ", "Isaac Newton", "Nikola Tesla", "Grace Hopper", "Ada Lovelace", "Alan Turing"];
...
guestList.forEach(person => console.log(`Dear ${person}, you are still invited to dinner with me. I would be honored by your presence.`));
